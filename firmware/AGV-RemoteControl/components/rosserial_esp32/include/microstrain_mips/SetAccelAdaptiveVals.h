#ifndef _ROS_SERVICE_SetAccelAdaptiveVals_h
#define _ROS_SERVICE_SetAccelAdaptiveVals_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETACCELADAPTIVEVALS[] = "microstrain_mips/SetAccelAdaptiveVals";

  class SetAccelAdaptiveValsRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SETACCELADAPTIVEVALS; };
    const char * getMD5(){ return "ea0a038591e6f2c00f93fee5561157dc"; };

  };

  class SetAccelAdaptiveValsResponse : public ros::Msg
  {
    public:
      typedef bool _success_type;
      _success_type success;

    SetAccelAdaptiveValsResponse():
      success(0)
    {
    }
