#ifndef _ROS_SERVICE_SetAccelBiasModel_h
#define _ROS_SERVICE_SetAccelBiasModel_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETACCELBIASMODEL[] = "microstrain_mips/SetAccelBiasModel";

  class SetAccelBiasModelRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SETACCELBIASMODEL; };
    const char * getMD5(){ return "89f0f0cd6d52eb4058eea24a6259c0d1"; };

  };

  class SetAccelBiasModelResponse : public ros::Msg
  {
    public:
      typedef bool _success_type;
      _success_type success;

    SetAccelBiasModelResponse():
      success(0)
    {
    }
