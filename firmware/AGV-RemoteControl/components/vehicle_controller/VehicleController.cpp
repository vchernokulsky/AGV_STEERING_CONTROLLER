...
//    }
    ...
    adc1_config_channel_atten(RIGHT_WHEEL_ADC_CHANNEL, ADC_ATTEN_DB_11);
    adc1_config_channel_atten(LEFT_WHEEL_ADC_CHANNEL, ADC_ATTEN_DB_11);
...
//    }
    leftWheelSpeedVal = adc1_get_raw((adc1_channel_t)LEFT_WHEEL_ADC_CHANNEL);
    rightWheelSpeedVal = adc1_get_raw((adc1_channel_t)RIGHT_WHEEL_ADC_CHANNEL);
