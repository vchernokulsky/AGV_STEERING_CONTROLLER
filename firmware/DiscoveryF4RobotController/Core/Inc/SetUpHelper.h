...
#define WHEEL_RADIUS_OFFSET 29
#define WHEEL_SEPARATION_OFFSET 31
#define MAX_LIN_VEL_OFFSET 33
#define MAX_ANG_VEL_OFFSET 35
#define RAD_PER_TICK_OFFSET 37
#define MAX_PWD_ALLOWED_OFFSET 39
