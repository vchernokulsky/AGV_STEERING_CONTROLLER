...
#define ROBOT_GEOMETRY_OFFSET 29


#define LOCAL_IP_OFFSET 6
#define NETWORK_MASK_OFFSET 10
#define GATEAWAY_OFFSET 14
#define DHCP_CONFIG_OFFSET 18
#define ROS_CLIENT_PORT_OFFSET 19
#define SET_UP_SERVER_PORT_OFFSET 21
#define SERIALNODE_IP_OFFSET 23
#define SERIALNODE_PORT_OFFSET 27

#define DRIVER_TYPE_OFFSET 29
#define WHEEL_RADIUS_OFFSET 30
#define WHEEL_SEPARATION_OFFSET 32
#define MAX_LIN_VEL_OFFSET 34
#define MAX_ANG_VEL_OFFSET 36
#define RAD_PER_TICK_OFFSET 38
#define MAX_PWD_ALLOWED_OFFSET 40

#define TOPICS_OFFSET 42
